const resources = [
  ...
  ["Operations", "Standard operating procedure guide"],
  ...
  ["Business", "Monthly report framework"],
  ...
  ["Business", "Project brief framework"],
  ...
  ["Safety", "Job hazard analysis guide"],
...
function inferType(title) {
  ...
  if (lower.includes("email") || lower.includes("message") || lower.includes("letter") || lower.includes("script")) return "Communication";
